...
int mqnic_alloc_tx_ring(struct rte_eth_dev *dev, struct mqnic_ring *txq, int size, int stride)
{
...
void mqnic_destroy_tx_ring(struct rte_eth_dev *dev, struct mqnic_ring *ring)
{
...
int mqnic_process_tx_cq(struct mqnic_ring *tx_ring)
{
	PMD_INIT_FUNC_TRACE();
