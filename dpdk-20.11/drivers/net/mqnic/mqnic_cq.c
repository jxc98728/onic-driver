...
int mqnic_alloc_cq_ring(struct rte_eth_dev *dev, struct mqnic_cq_ring *ring, int size, int stride,
						bool is_tx)
{
...
void mqnic_destroy_cq_ring(struct rte_eth_dev *dev, struct mqnic_cq_ring *ring, bool is_tx)
{
	if (ring != NULL)
	{
